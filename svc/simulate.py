...
def save_alpha_simulate_result(alpha_id, simulate_id, s, table_name):
    ...
    set_data = {
        ...
        'train_long': r.get('train', {}).get('longCount', 0),
        'train_short': r.get('train', {}).get('shortCount', 0),
        'test_long': r.get('test', {}).get('longCount', 0),
        'test_short': r.get('test', {}).get('shortCount', 0),
        'passed': passed,
